...
const myStuff = [
    ...
    },
    {
        ...
        img: './assets/images/web-api-code-quiz.gif'
    },
    {
        title: 'Weather Dashboard',
        desc: 'Simple weather dashboard created using <a href="https://openweathermap.org/">OpenWeatherAPI</a>',
        repo: 'https://github.com/rheneadianne/weather-dashboard',
        live: 'https://rheneadianne.github.io/weather-dashboard',
        img: './assets/images/Weather_Dashboard.gif'
    },
    {
        ...
        img: './assets/images/scheduler.gif"'
    }
]
